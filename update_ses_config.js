...
console.log('Encrypted Access Key ID length:', encryptedAccessKeyId.length);
console.log('Encrypted Secret Access Key length:', encryptedSecretAccessKey.length);

// Generate SQL update statement
console.log('\nSQL to update SES configuration:');
console.log(`UPDATE ses_configurations 
SET 
...
// Also output the values for direct use
console.log('\nEncrypted values for direct update:');
console.log('access_key_id:', encryptedAccessKeyId);
console.log('secret_access_key:', encryptedSecretAccessKey);