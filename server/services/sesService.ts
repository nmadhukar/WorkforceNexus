...
HR Management System
   ...
   * 
   * @description
   * Creates a professional HTML email template for password reset requests.
   * The template includes:
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="footer">
                ...
                <p>
                  If you continue to have problems accessing your account, please contact your HR department 
   ...
   * 
   * @description
   * Creates a plain text version of the password reset email for
   * accessibility and email clients that don't support HTML.
   */
...
HR Management System
   ...
   * 
   * The method automatically:
   * - Generates the complete reset link with token
   ...
   * 
   * if (result.success) {
   *   console.log('Password reset email sent with ID:', result.messageId);
   * }
   */
